...
public class VoluntaryEmergencyController {
    ...
    @GetMapping("/")
    @ResponseBody
    public ResponseEntity<List<VoluntaryEmergencyDto>> getAllRoles(){
        try{
    ...
    @GetMapping("/{id}")
    @ResponseBody
    public ResponseEntity<VoluntaryEmergencyDto> findRoleById (@PathVariable("id") Integer id){
        try{
    ...
    @ResponseBody
    public ResponseEntity create (@RequestBody VoluntaryEmergencyDto voluntaryEmergencyDto){
        try{
    ...
    @PutMapping("/edit/{id}")
    @ResponseBody
    public ResponseEntity update (@PathVariable("id") Integer id, @RequestBody VoluntaryEmergencyDto voluntaryEmergencyDto){
        try{
