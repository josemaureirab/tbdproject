...
INSERT INTO users (id, active, birthDate, firstName, lastName, password, rut, age, userName)
values (1, true, null, null, null, '{bcrypt}$2a$10$0SVxeMe2zWUG2iRt6zc/C.fvjz.pI5mZeSSYp/IzpivQmiQlUdZrO', null, null, 'user'), (2, true, null, null, null, '{bcrypt}$2a$10$0SVxeMe2zWUG2iRt6zc/C.fvjz.pI5mZeSSYp/IzpivQmiQlUdZrO', null, null, 'user');

INSERT INTO user_roles (id, user_id, role)
values (1, 1, 'normalUser'), (2, 2, 'normalUser'), (3, 2, 'adminUser');