...
@EnableJpaRepositories(
    basePackages = "cl.rollers.tbdproject.SQL.secondDataSource.dao",
...
public class SecondDataSourceConfiguration {
  ...
  public DataSource secondDataSource() {
    DataSourceProperties primaryDataSourceProperties = secondDataSourceProperties();
  ...
  public LocalContainerEntityManagerFactoryBean secondEntityManagerFactory()
  {
    ...
    factory.setPackagesToScan(new String[]{"cl.rollers.tbdproject.SQL.secondDataSource.models"});
